  ...
  return (
    <div className='home'>
      ...
      <div className="catalogo">
        <div className="categoriaCortina">
      ...
      <div className="clientesCont">
          <div className="cliente">
            <img src={logo} alt="" />
            <p>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Amet totam iste ratione possimus, pariatur accusamus, ipsum voluptas dolor.</p>
          </div>
          <div className="cliente">
            <img src={logo} alt="" />
            <p>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Amet totam iste ratione possimus, pariatur accusamus, ipsum voluptas dolor.</p>
